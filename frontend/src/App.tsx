...
function App() {
  ...
  const [selectedAgent, setSelectedAgent] = useState<"gemini" | "claude">(
    "gemini"
  );
  ...
  useEffect(() => {
    ...
    if (savedActiveConversation) {
      ...
      const savedMessages = localStorage.getItem(
        `messages_${savedActiveConversation}`
      );
      if (savedMessages) {
            ...
            <>
              <div style={{ padding: "1rem" }}>
                ...
                <select
                  ...
                  value={selectedAgent}
                  onChange={(e) =>
                    setSelectedAgent(e.target.value as "gemini" | "claude")
                  }
